...
Hoy, una nueva tecnología está transformando el diseño y la gestión de las plataformas de internet de servicios. Esta tecnología se denomina contenedores (por ejemplo, Docker y LXC). El sector de internet de servicios está adoptando la tecnología de contenedores tanto para uso interno como para su comercialización. El uso de contenedores como tecnología base para sistemas a gran escala plantea numerosos desafíos en la gestión de recursos en tiempo de ejecución, como el autoescalado, el despliegue óptimo y la monitorización. En concreto, la monitorización de sistemas basados ​​en contenedores es fundamental para cualquier solución de gestión de recursos, y constituye el objetivo principal de este trabajo. Este documento explora las herramientas disponibles para medir el rendimiento de Docker desde la perspectiva del sistema operativo anfitrión y del entorno de virtualización, y proporciona una caracterización de la sobrecarga de CPU y E/S de disco que generan los contenedores.
